      ...
      <Row className="p-0 justify-content-lg-between justify-content-center align-items-center result-row">
        ...
        <Card className="text-center p-0 ">
          ...
          <div className="card-body">
            <p className="lead">Your final result is {Math.round(parseInt(result))}% out of 100%</p>
            <button
        ...
        <Col md={5}>
          {parseInt(result)>70? <img className="img-fluid" src={hundred} alt="amazing" />: "" }
          {parseInt(result)>50 && parseInt(result) <70? <img className="img-fluid" src={seventy} alt="good" />: "" }
          {parseInt(result)<50? <img className="img-fluid" src={bad} alt="bad" />: "" }
        </Col>
      </Row>
    </Container>
  );
